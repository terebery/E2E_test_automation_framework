...
```bash
git clone https://github.com/terebery/E2E_test_automation_framework.git
cd E2E_test_automation_framework
mvn test
```
...
![Tests](https://github.com/terebery/E2E_test_automation_framework/actions/workflows/tests.yml/badge.svg)
